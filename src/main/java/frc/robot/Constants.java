...
public final class Constants {
    ...
    public static class motorPorts {
        public static final int WOF_MOTOR_PORT = 12;
        public static final int elevatorMotorPortOne = 6;
        // public static final int elevatorMotorPortTwo = 2;
        public static final int intakeMotorPort = 7;
        public static final int indexMotorPort = 5;
    }
    ...
    public static class Pistons{
        public static final int[] actuatorPistonPort = {4, 5};
